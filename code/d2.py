...
path = "E:\\AI Project\\Datasets\\chronic_kidney_disease_prepared.csv"
df = pd.read_csv(path)
...
X_before_preprocessing.to_excel(
    r"E:\AI Project\Excel Sheets\D2\X_Before_Preprocessing.xlsx",
    index=False
)
...
X_before_3.to_excel(
    r"E:\AI Project\Excel Sheets\D2\X_First3_Before_Preprocessing.xlsx",
    index=False
)
...
num_labels = df["Class"].nunique()  # defines the variable
...
# Save to Excel
cv_df.to_excel(r"E:\AI Project\Excel Sheets\D2\CV_Results.xlsx", index=True)
...
# Save to Excel
train_metrics_df.to_excel(r"E:\AI Project\Excel Sheets\D2\Train_Metrics_CV.xlsx", index=False)
...
report_df.to_excel(r"E:\AI Project\Excel Sheets\D2\Classification_Report.xlsx", index=True)
...
X_train_preprocessed_df.to_excel(
    r"E:\AI Project\Excel Sheets\D2\X_After_Preprocessing.xlsx",
    index=False)

X_after_3 = X_train_preprocessed_df.head(3)

X_after_3.to_excel(
    r"E:\AI Project\Excel Sheets\D2\X_First3_After_Preprocessing.xlsx",
    index=False
)
